...
public class QChatRoom extends EntityPathBase<ChatRoom> {
    ...
    public final org.danpoong.zipcock_44.domain.user.QUser buyer;
    ...
    public final org.danpoong.zipcock_44.domain.user.QUser seller;
    ...
    public QChatRoom(Class<? extends ChatRoom> type, PathMetadata metadata, PathInits inits) {
        ...
        this.buyer = inits.isInitialized("buyer") ? new org.danpoong.zipcock_44.domain.user.QUser(forProperty("buyer")) : null;
        ...
        this.seller = inits.isInitialized("seller") ? new org.danpoong.zipcock_44.domain.user.QUser(forProperty("seller")) : null;
    }
