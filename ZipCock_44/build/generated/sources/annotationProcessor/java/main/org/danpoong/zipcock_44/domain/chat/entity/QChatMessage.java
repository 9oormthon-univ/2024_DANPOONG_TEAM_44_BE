...
public class QChatMessage extends EntityPathBase<ChatMessage> {
    ...
    public final org.danpoong.zipcock_44.domain.user.QUser sender;
    ...
    public QChatMessage(Class<? extends ChatMessage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.sender = inits.isInitialized("sender") ? new org.danpoong.zipcock_44.domain.user.QUser(forProperty("sender")) : null;
    }
