...
import org.danpoong.zipcock_44.domain.post.repository.ImageRepository;
...
public class PostService {
    ...
    @Transactional
    public Post createPostWithJson(Long userId, String content, List<Image> images, String title, double latitude, double longitude) {
